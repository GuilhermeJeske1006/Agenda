    ...
    <form action="recebeDadosLocal.jsp?" method="POST">
        <div class="row mb-3">
            <div class="col">
                ...
                <input type="text" class="form-control" placeholder="Informe nome" name="nome" id="nome">
                <!-- Mensagem de erro -->
            ...
            <div class="col">
                ...
                <input type="text" maxlength="9" onkeyup="handleZipCode(event)" class="form-control" placeholder="Informe o CEP" name="cep" id="cep" onblur="verEndereco()">
                <!-- Mensagem de erro -->
        ...
        <div class="row mb-3">
            ...
            <div class="col">
                ...
                <input type="text" class="form-control" placeholder="Informe a rua" name="rua" id="rua" readonly style="background-color: #f2f2f2; color: #888; cursor: not-allowed;">
                <!-- Mensagem de erro -->
            ...
            <div class="col">
                ...
                <input type="number" class="form-control" placeholder="Informe o número" name="numero" id="numero">
                <!-- Mensagem de erro -->
        ...
        <div class="row mb-3">
            <div class="col">
                ...
                <input type="text" class="form-control" placeholder="Informe o bairro" name="bairro" id="bairro" readonly style="background-color: #f2f2f2; color: #888; cursor: not-allowed;">
                <!-- Mensagem de erro -->
            ...
            <div class="col">
                ...
                <input type="text" class="form-control" placeholder="Informe a cidade" name="cidade" id="cidade" readonly style="background-color: #f2f2f2; color: #888; cursor: not-allowed;">
                <!-- Mensagem de erro -->
            ...
            <div class="col">
                ...
                <input type="text" class="form-control" placeholder="Informe o estado" name="estado" id="estado" readonly style="background-color: #f2f2f2; color: #888; cursor: not-allowed;">
                <!-- Mensagem de erro -->
...
<script>
	async function verEndereco() {
	    ...
	    var cepWithoutDash = inputCep.replace("-", "");
